 ...
 * @author: Dm
 */
class Api_Zhianbao_Regulator_Wechat_ReplyRule_Content_Update extends PhalApi_Api {
  ...
  /**
    ...
    public function Go() {
        ...
        $domain->updateReplyRuleContent($info,$this->replyRuleContentId,$this->replyRuleContent);
