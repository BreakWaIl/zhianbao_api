 ...
 * @author: Dm
 */
class Api_Zhianbao_Regulator_SafeSelf_Review_EndReject extends PhalApi_Api {
    ...
    public function getRules() {
        return array (
            'Go' => array(
                ...
                'endRejectRemark' => array('name' => 'end_reject_remark','type'=>'string', 'min' => 1, 'require'=> true,'desc'=> '拒绝理由'),
            ),
        );
    }
    ...
    public function Go() {
        ...
        try {
            ...
            $applyDomain = new Domain_Zhianbao_SafeApply();
            $res = $applyDomain->EndReject($applyInfo,$this->endRejectRemark);
