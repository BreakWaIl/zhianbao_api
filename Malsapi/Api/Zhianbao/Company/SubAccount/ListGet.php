 ...
 * @author: Andy
 */
class Api_Zhianbao_Company_SubAccount_ListGet extends PhalApi_Api {
    ...
    public function Go() {
        ...
        $list = $userDomain->getSubAccountList($filter,$this->page,$this->pageSize,$this->orderby);
        $total = $userDomain->getSubUserCount($filter);
