 ...
 * @author: Dm
 */
class Api_Building_DataReport_Bill_ListGet extends PhalApi_Api {
  ...
  /**
     ...
     * #return float expenditureTotal 支出总数
     * #return float incomeTotal 收入总数
     * * #return float borrowTotal 借支总数
  */
    public function Go() {
        ...
        $list = $dateReportDomain->getProjectBillInfo($filter,$this->page,$this->pageSize);
        if( !$list){
            $rs['code'] = 189;
