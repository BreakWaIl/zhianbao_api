 ...
 * @author: Dm
 */
class Api_Building_Bill_Project_ListGet extends PhalApi_Api {
   ...
   */
    public function Go() {
        ...
        $list = $billProjectDomain->getAllByPage($filter,$this->page,$this->pageSize,$this->orderby);
        $count = $billProjectDomain->getCount($filter);
