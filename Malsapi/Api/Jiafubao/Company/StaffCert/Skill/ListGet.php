 ...
 * @author: Dm
 */
class Api_Jiafubao_Company_StaffCert_Skill_ListGet extends PhalApi_Api {
	...
	public function getRules() {
		return array (
				 'Go' => array(
                     ...
                     'type' => array('name' => 'type', 'type'=>'enum', 'range' => array('society','government'), 'require'=> false,'desc'=> '证书类型:society 协会  government 政府'),
