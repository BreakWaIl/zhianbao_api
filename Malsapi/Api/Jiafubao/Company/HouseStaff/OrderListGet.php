 ...
 * @author: Dm
 */
class Api_Jiafubao_Company_HouseStaff_OrderListGet extends PhalApi_Api {
  ...
  /**
    ...
    public function Go() {
        ...
        $list = $houseStaffDomain->getCanOrderAllByPage($filter,$this->page,$this->pageSize,$this->orderby);
        $rs['list'] = $list;
        $rs['total'] = count($list);
        return $rs;
    }
